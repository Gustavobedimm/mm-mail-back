...
app.post("/send-mail", async (req, res) => {
  ...
  docpdf.fontSize(10);
  docpdf.font("Helvetica");
  docpdf.rect(40, 254, 480, 150).stroke();
  docpdf.rect(40, 254, 480, 15).stroke();
  docpdf.rect(370, 419, 180, 15).stroke();
  docpdf.fontSize(11);
  docpdf.font("Helvetica-Bold").text("VALOR TOTAL : R$ " + valor, 380, 423);
  docpdf.fontSize(10);
  docpdf.font("Helvetica");
  docpdf.rect(40, 449, 480, 100).stroke();
  docpdf.rect(40, 449, 480, 15).stroke();
  docpdf.fontSize(11);
  docpdf.font("Helvetica-Bold").text("OBSERVAÇÕES", 270, 453);
  docpdf.font("Helvetica");
  docpdf.fontSize(10);
  docpdf.text("Orçamento válido por 15 dias, após a data de emissão.", 40, 535);
  docpdf.fontSize(11);
  docpdf.moveDown(5);
